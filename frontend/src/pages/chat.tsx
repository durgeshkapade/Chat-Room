...
function ChatPage() {
  ...
  return (
    <div className=' h-screen flex items-center justify-center overflow-hidden flex-col'>
      <header className="mb-4 flex min-w-[330px]  w-[40%]   justify-between items-center bg-slate-400 p-4 dark:text-white rounded-t-lg shadow-md">
        <div className="text-lg font-semibold">{username}</div> {/* Display the username */}
      </header>

      <div className=' min-w-[330px]  w-[40%]  h-[80%]'>
